...
def save_to_csv(ip_requests, most_accessed_endpoint, suspicious_ips, file_name='log_analysis_results(v1.0).csv'):
...
if __name__ == "__main__":
    ...
    print("\nResults saved to 'log_analysis_results(v1.0).csv'")